...
export function Info() {
    ...
    const descriptionText = [
        ...
        "This personal website is Matt's own creation.  He utilized {vite} to create a quick app, built the application using React and Typescript, and deployed in Microsoft Azure as a {azurewebapp}.",
    ]
    return (<div>{descriptionText.map(text => <div>{formatLinks(text, links)}</div>)}</div>)
}